...
const MonButton: React.FC<MonButtonProps> = ({ text, addArrow = true, href, onClick }) => {
  return (
    <a href={href ?? '/#'} target="_blank" rel="noopener noreferrer" className="inline-flex">
      ...
      >
        ...
        {addArrow && (
          <Image width={24} height={24} className={ButtonStyles.buttonIcon} src="/assets/img/arrow-right.svg" alt="Arrow Right" />
        )}
      </button>
    </a>
  );
