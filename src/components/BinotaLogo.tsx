export function BinotaLogo({ size = 32 }: { size?: number }) {
  return (
    <div>
      <svg fill="none" height={size} width={size} viewBox="0 0 32 32">
        <path
        ...
        <path
          ...
          fill="#F5D93A"
        />
        <path d="M10.667 31.09C4.452 28.893 0 22.967 0 16h10.667v15.09Z" fill="#405AE5" />
        <path d="M0 16h10.667V.91C4.452 3.107 0 9.034 0 16Z" fill="#FB7C59" />
      </svg>
    </div>
  );
}

export default BinotaLogo;
